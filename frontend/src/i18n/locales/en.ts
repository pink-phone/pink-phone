...
export const en: Resources = {
  ...
  dashboard: {
    ...
    moodHidden: "Post your mood to reveal theirs.",
  ...
  settings: {
    ...
    blindMood: "Blind mood",
    blindMoodHint:
      "Your partner's mood stays hidden until you've posted yours for the day. Revealed once you've both voted.",
